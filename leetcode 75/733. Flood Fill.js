...
const floodFill = (image, sr, sc, newColor, firstColor = image[sr][sc]) => {
  ...
  floodFill(image, sr - 1, sc, newColor, firstColor); // top
  floodFill(image, sr + 1, sc, newColor, firstColor); // down
  floodFill(image, sr, sc - 1, newColor, firstColor); // left
  floodFill(image, sr, sc + 1, newColor, firstColor); // right
